...
INSERT INTO teams (id, tournament_id, name, color, "group", created_at, updated_at) VALUES
  ('team-a', 'tdst-season-1', 'Team A', '#FF5733', 1, NOW(), NOW()),
  ('team-b', 'tdst-season-1', 'Team B', '#3498DB', 1, NOW(), NOW()),
  ('team-c', 'tdst-season-1', 'Team C', '#E74C3C', 1, NOW(), NOW()),
  ('team-d', 'tdst-season-1', 'Team D', '#9B59B6', 1, NOW(), NOW()),
  ('team-e', 'tdst-season-1', 'Team E', '#F39C12', 1, NOW(), NOW());

-- GROUP 2 TEAMS: F, G, H, I, J
INSERT INTO teams (id, tournament_id, name, color, "group", created_at, updated_at) VALUES
  ('team-f', 'tdst-season-1', 'Team F', '#16A085', 2, NOW(), NOW()),
  ('team-g', 'tdst-season-1', 'Team G', '#D35400', 2, NOW(), NOW()),
  ('team-h', 'tdst-season-1', 'Team H', '#2980B9', 2, NOW(), NOW()),
  ('team-i', 'tdst-season-1', 'Team I', '#F1C40F', 2, NOW(), NOW()),
  ('team-j', 'tdst-season-1', 'Team J', '#34495E', 2, NOW(), NOW());

-- GROUP 3 TEAMS: K, L, M, N, O
INSERT INTO teams (id, tournament_id, name, color, "group", created_at, updated_at) VALUES
  ('team-k', 'tdst-season-1', 'Team K', '#27AE60', 3, NOW(), NOW()),
  ('team-l', 'tdst-season-1', 'Team L', '#C0392B', 3, NOW(), NOW()),
  ('team-m', 'tdst-season-1', 'Team M', '#3498DB', 3, NOW(), NOW()),
  ('team-n', 'tdst-season-1', 'Team N', '#E67E22', 3, NOW(), NOW()),
  ('team-o', 'tdst-season-1', 'Team O', '#8E44AD', 3, NOW(), NOW());

-- GROUP 4 TEAMS: P, Q, R, S, T
INSERT INTO teams (id, tournament_id, name, color, "group", created_at, updated_at) VALUES
  ('team-p', 'tdst-season-1', 'Team P', '#95A5A6', 4, NOW(), NOW()),
  ('team-q', 'tdst-season-1', 'Team Q', '#196F3D', 4, NOW(), NOW()),
  ('team-r', 'tdst-season-1', 'Team R', '#566573', 4, NOW(), NOW()),
  ('team-s', 'tdst-season-1', 'Team S', '#DC7633', 4, NOW(), NOW()),
  ('team-t', 'tdst-season-1', 'Team T', '#6C3483', 4, NOW(), NOW());
...
INSERT INTO matches (id, tournament_id, match_number, court, start_time, umpire_id, umpire_name, team_ids, state, stage, batting_order, rankings, locked_at, created_at, updated_at) VALUES
  ('match-01', 'tdst-season-1', 1, 'Court A', '2026-03-03 20:50:00', NULL, NULL, ARRAY['team-a', 'team-f', 'team-k', 'team-p'], 'CREATED', 'LEAGUE', '{}', '[]', NULL, NOW(), NOW()),
  ('match-02', 'tdst-season-1', 2, 'Court A', '2026-03-03 21:30:00', NULL, NULL, ARRAY['team-b', 'team-g', 'team-l', 'team-q'], 'CREATED', 'LEAGUE', '{}', '[]', NULL, NOW(), NOW()),
  ('match-03', 'tdst-season-1', 3, 'Court A', '2026-03-03 22:10:00', NULL, NULL, ARRAY['team-c', 'team-h', 'team-m', 'team-r'], 'CREATED', 'LEAGUE', '{}', '[]', NULL, NOW(), NOW()),
  ('match-04', 'tdst-season-1', 4, 'Court A', '2026-03-03 22:50:00', NULL, NULL, ARRAY['team-d', 'team-i', 'team-n', 'team-s'], 'CREATED', 'LEAGUE', '{}', '[]', NULL, NOW(), NOW()),
  ('match-05', 'tdst-season-1', 5, 'Court A', '2026-03-03 23:30:00', NULL, NULL, ARRAY['team-e', 'team-j', 'team-o', 'team-t'], 'CREATED', 'LEAGUE', '{}', '[]', NULL, NOW(), NOW());

-- ROUND 1 continued (Match 6) - Thursday
INSERT INTO matches (id, tournament_id, match_number, court, start_time, umpire_id, umpire_name, team_ids, state, stage, batting_order, rankings, locked_at, created_at, updated_at) VALUES
  ('match-06', 'tdst-season-1', 6, 'Court A', '2026-03-03 20:10:00', NULL, NULL, ARRAY['team-a', 'team-g', 'team-m', 'team-t'], 'CREATED', 'LEAGUE', '{}', '[]', NULL, NOW(), NOW());

-- ROUND 2 (Matches 7-10) - Friday, March 4
INSERT INTO matches (id, tournament_id, match_number, court, start_time, umpire_id, umpire_name, team_ids, state, stage, batting_order, rankings, locked_at, created_at, updated_at) VALUES
  ('match-07', 'tdst-season-1', 7, 'Court A', '2026-03-04 20:00:00', NULL, NULL, ARRAY['team-b', 'team-h', 'team-n', 'team-p'], 'CREATED', 'LEAGUE', '{}', '[]', NULL, NOW(), NOW()),
  ('match-08', 'tdst-season-1', 8, 'Court A', '2026-03-04 20:40:00', NULL, NULL, ARRAY['team-c', 'team-i', 'team-o', 'team-q'], 'CREATED', 'LEAGUE', '{}', '[]', NULL, NOW(), NOW()),
  ('match-09', 'tdst-season-1', 9, 'Court A', '2026-03-04 21:20:00', NULL, NULL, ARRAY['team-d', 'team-j', 'team-k', 'team-r'], 'CREATED', 'LEAGUE', '{}', '[]', NULL, NOW(), NOW()),
  ('match-10', 'tdst-season-1', 10, 'Court A', '2026-03-04 22:00:00', NULL, NULL, ARRAY['team-e', 'team-f', 'team-l', 'team-s'], 'CREATED', 'LEAGUE', '{}', '[]', NULL, NOW(), NOW());

-- ROUND 3 (Matches 11-14) - Friday continued
INSERT INTO matches (id, tournament_id, match_number, court, start_time, umpire_id, umpire_name, team_ids, state, stage, batting_order, rankings, locked_at, created_at, updated_at) VALUES
  ('match-11', 'tdst-season-1', 11, 'Court A', '2026-03-04 22:40:00', NULL, NULL, ARRAY['team-a', 'team-h', 'team-o', 'team-s'], 'CREATED', 'LEAGUE', '{}', '[]', NULL, NOW(), NOW()),
  ('match-12', 'tdst-season-1', 12, 'Court A', '2026-03-04 23:20:00', NULL, NULL, ARRAY['team-b', 'team-i', 'team-k', 'team-t'], 'CREATED', 'LEAGUE', '{}', '[]', NULL, NOW(), NOW()),
  ('match-13', 'tdst-season-1', 13, 'Court A', '2026-03-05 00:00:00', NULL, NULL, ARRAY['team-c', 'team-j', 'team-l', 'team-p'], 'CREATED', 'LEAGUE', '{}', '[]', NULL, NOW(), NOW()),
  ('match-14', 'tdst-season-1', 14, 'Court A', '2026-03-05 00:40:00', NULL, NULL, ARRAY['team-d', 'team-f', 'team-m', 'team-q'], 'CREATED', 'LEAGUE', '{}', '[]', NULL, NOW(), NOW());

-- ROUND 3 & 4 (Matches 15-18) - Saturday, March 5
INSERT INTO matches (id, tournament_id, match_number, court, start_time, umpire_id, umpire_name, team_ids, state, stage, batting_order, rankings, locked_at, created_at, updated_at) VALUES
  ('match-15', 'tdst-season-1', 15, 'Court A', '2026-03-05 20:00:00', NULL, NULL, ARRAY['team-e', 'team-g', 'team-n', 'team-r'], 'CREATED', 'LEAGUE', '{}', '[]', NULL, NOW(), NOW()),
  ('match-16', 'tdst-season-1', 16, 'Court A', '2026-03-05 20:40:00', NULL, NULL, ARRAY['team-a', 'team-i', 'team-l', 'team-r'], 'CREATED', 'LEAGUE', '{}', '[]', NULL, NOW(), NOW()),
  ('match-17', 'tdst-season-1', 17, 'Court A', '2026-03-05 21:20:00', NULL, NULL, ARRAY['team-b', 'team-j', 'team-m', 'team-s'], 'CREATED', 'LEAGUE', '{}', '[]', NULL, NOW(), NOW()),
  ('match-18', 'tdst-season-1', 18, 'Court A', '2026-03-05 22:00:00', NULL, NULL, ARRAY['team-c', 'team-f', 'team-n', 'team-t'], 'CREATED', 'LEAGUE', '{}', '[]', NULL, NOW(), NOW());

-- ROUND 4 (Matches 19-20) - Saturday continued
INSERT INTO matches (id, tournament_id, match_number, court, start_time, umpire_id, umpire_name, team_ids, state, stage, batting_order, rankings, locked_at, created_at, updated_at) VALUES
  ('match-19', 'tdst-season-1', 19, 'Court A', '2026-03-05 22:40:00', NULL, NULL, ARRAY['team-d', 'team-g', 'team-o', 'team-p'], 'CREATED', 'LEAGUE', '{}', '[]', NULL, NOW(), NOW()),
  ('match-20', 'tdst-season-1', 20, 'Court A', '2026-03-05 23:20:00', NULL, NULL, ARRAY['team-e', 'team-h', 'team-k', 'team-q'], 'CREATED', 'LEAGUE', '{}', '[]', NULL, NOW(), NOW());

-- ROUND 5 (Matches 21-25) - Sunday, March 6
INSERT INTO matches (id, tournament_id, match_number, court, start_time, umpire_id, umpire_name, team_ids, state, stage, batting_order, rankings, locked_at, created_at, updated_at) VALUES
  ('match-21', 'tdst-season-1', 21, 'Court A', '2026-03-06 20:00:00', NULL, NULL, ARRAY['team-a', 'team-b', 'team-c', 'team-d'], 'CREATED', 'LEAGUE', '{}', '[]', NULL, NOW(), NOW()),
  ('match-22', 'tdst-season-1', 22, 'Court A', '2026-03-06 20:40:00', NULL, NULL, ARRAY['team-e', 'team-f', 'team-g', 'team-h'], 'CREATED', 'LEAGUE', '{}', '[]', NULL, NOW(), NOW()),
  ('match-23', 'tdst-season-1', 23, 'Court A', '2026-03-06 21:20:00', NULL, NULL, ARRAY['team-i', 'team-j', 'team-k', 'team-l'], 'CREATED', 'LEAGUE', '{}', '[]', NULL, NOW(), NOW()),
  ('match-24', 'tdst-season-1', 24, 'Court A', '2026-03-06 22:00:00', NULL, NULL, ARRAY['team-m', 'team-n', 'team-o', 'team-p'], 'CREATED', 'LEAGUE', '{}', '[]', NULL, NOW(), NOW()),
  ('match-25', 'tdst-season-1', 25, 'Court A', '2026-03-06 22:40:00', NULL, NULL, ARRAY['team-q', 'team-r', 'team-s', 'team-t'], 'CREATED', 'LEAGUE', '{}', '[]', NULL, NOW(), NOW());
...
BEGIN
  ...
  RAISE NOTICE '   ';
  RAISE NOTICE '🚀 Ready to start scoring!';
END $$;
