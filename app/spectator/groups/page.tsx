...
export default function GroupStandingsPage() {
  ...
  return (
    <div className="p-4 md:p-8">
      ...
      {groupStandings && (
        <div className="mt-8 p-6 bg-gradient-to-r from-[#0d3944] to-[#1a4a57] rounded-lg border-2 border-[#ff9800]">
          <div className="flex items-start gap-3">
            <Trophy className="w-6 h-6 text-[#ff9800] mt-1" />
            <div>
              <h3 className="text-xl font-black text-white mb-2">Playoff Format</h3>
              <div className="space-y-2 text-white/90 font-medium">
                <p>🥇 <strong className="text-[#ff9800]">Semi-Final 1:</strong> G1-1st, G2-2nd, G3-1st, G4-2nd</p>
                <p>🥈 <strong className="text-[#ff9800]">Semi-Final 2:</strong> G1-2nd, G2-1st, G3-2nd, G4-1st</p>
                <p>🏆 <strong className="text-[#ff9800]">Final:</strong> Top 2 from each semi (4 teams)</p>
              </div>
