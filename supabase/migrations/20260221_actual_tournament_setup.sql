...
INSERT INTO tournaments (
  ...
  'tdst-season-2',
  'TDST – Season 2',
  'Toloba Dual Strike Tournament – Season 2',
  'Toloba',
  'TBD',
  '2026-03-03',
  '2026-03-06',
...
INSERT INTO teams (id, tournament_id, name, color, "group", created_at, updated_at) VALUES
  ('team-dhaba', 'tdst-season-2', 'Dhaba', '#FF5733', 1, NOW(), NOW()),                          -- A
  ('team-dhanera', 'tdst-season-2', 'Dhanera Daredevils', '#3498DB', 1, NOW(), NOW()),          -- B
  ('team-dragons', 'tdst-season-2', 'Dragons', '#E74C3C', 1, NOW(), NOW()),                     -- C
  ('team-dynamic', 'tdst-season-2', 'Dynamic Duo', '#9B59B6', 1, NOW(), NOW()),                 -- D
  ('team-hakimi', 'tdst-season-2', 'Hakimi Dynamos', '#F39C12', 1, NOW(), NOW());               -- E

-- GROUP 2 TEAMS (F-J)
INSERT INTO teams (id, tournament_id, name, color, "group", created_at, updated_at) VALUES
  ('team-hunters', 'tdst-season-2', 'Hunters', '#16A085', 2, NOW(), NOW()),                     -- F
  ('team-khatte', 'tdst-season-2', 'Khatte Angoor', '#D35400', 2, NOW(), NOW()),                -- G
  ('team-ma', 'tdst-season-2', 'MA Stars', '#2980B9', 2, NOW(), NOW()),                         -- H
  ('team-nahda', 'tdst-season-2', 'Nahda Shooters', '#F1C40F', 2, NOW(), NOW()),                -- I
  ('team-nuqum', 'tdst-season-2', 'Nuqum Rock', '#34495E', 2, NOW(), NOW());                    -- J

-- GROUP 3 TEAMS (K-O)
INSERT INTO teams (id, tournament_id, name, color, "group", created_at, updated_at) VALUES
  ('team-parallel', 'tdst-season-2', 'Parallel Power', '#27AE60', 3, NOW(), NOW()),             -- K
  ('team-royal', 'tdst-season-2', 'Royal Blasters', '#C0392B', 3, NOW(), NOW()),                -- L
  ('team-sakeena', 'tdst-season-2', 'Sakeena Strikers', '#3498DB', 3, NOW(), NOW()),            -- M
  ('team-sibling', 'tdst-season-2', 'Sibling Strikers', '#E67E22', 3, NOW(), NOW()),            -- N
  ('team-sultan', 'tdst-season-2', 'Sultan Strikers', '#8E44AD', 3, NOW(), NOW());              -- O

-- GROUP 4 TEAMS (P-T)
INSERT INTO teams (id, tournament_id, name, color, "group", created_at, updated_at) VALUES
  ('team-swat', 'tdst-season-2', 'Swat Katz', '#95A5A6', 4, NOW(), NOW()),                      -- P
  ('team-taher', 'tdst-season-2', 'Taher Ali', '#196F3D', 4, NOW(), NOW()),                     -- Q
  ('team-jade', 'tdst-season-2', 'Team Jade Jaguars', '#566573', 4, NOW(), NOW()),              -- R
  ('team-thunder', 'tdst-season-2', 'Thunder Strikers', '#DC7633', 4, NOW(), NOW()),            -- S
  ('team-wicket', 'tdst-season-2', 'Wicket Warriors', '#6C3483', 4, NOW(), NOW());              -- T
...
WITH team_match_counts AS (
  ...
  FROM matches
  WHERE tournament_id = 'tdst-season-2' AND stage = 'LEAGUE'
...
DO $$
BEGIN
  RAISE NOTICE '✅ TDST Season 2 setup complete!';
  RAISE NOTICE '📊 Summary:';
  RAISE NOTICE '   - 1 Tournament created (TDST – Season 2)';
